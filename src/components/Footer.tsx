      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center">
          ...
          <p className="text-white/60 text-center text-sm">
            &copy; {currentYear} All Rights Reserved | Made with <Heart className="inline-block h-4 w-4 text-red-500 mx-1" /> by 
            <span className="text-primary ml-1">John Doe</span>
          </p>
        </div>
      </div>
    </footer>
